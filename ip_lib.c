...
ip_mat * create_sharpen_filter(){
    int i;
    ip_mat *filter=ip_mat_create(3,3,3,0.);
    for(i=0;i<3;i++){
        set_val(filter,0,0,i,0.);
        set_val(filter,0,1,i,-1.);
        set_val(filter,0,2,i,0.);
        set_val(filter,1,0,i,-1.);
        set_val(filter,1,1,i,5.);
        set_val(filter,1,2,i,-1.);
        set_val(filter,2,0,i,0.);
        set_val(filter,2,1,i,-1.);
        set_val(filter,2,2,i,0.);
    }
...
ip_mat * create_edge_filter(){
    ...
    int i;
    for(i=0;i<3;i++){
        set_val(filter,0,0,i,-1.);
        set_val(filter,0,1,i,-1.);
        set_val(filter,0,2,i,-1.);
        set_val(filter,1,0,i,-1.);
        set_val(filter,1,1,i,8.);
        set_val(filter,1,2,i,-1.);
        set_val(filter,2,0,i,-1.);
        set_val(filter,2,1,i,-1.);
        set_val(filter,2,2,i,-1.);
    }
    compute_stats(filter);
    return filter;
}
...
ip_mat * create_emboss_filter(){
    ...
    int i;
    for(i=0;i<3;i++){
        set_val(filter,0,0,i,-2.);
        set_val(filter,0,1,i,-1.);
        set_val(filter,0,2,i,0.);
        set_val(filter,1,0,i,-1.);
        set_val(filter,1,1,i,1.);
        set_val(filter,1,2,i,1.);
        set_val(filter,2,0,i,0.);
        set_val(filter,2,1,i,1.);
        set_val(filter,2,2,i,2.);
    }
    compute_stats(filter);
    return filter;
}
